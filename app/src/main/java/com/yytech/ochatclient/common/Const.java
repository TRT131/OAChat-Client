...
public class Const {
    ...
    public static final String IP = "192.168.236.1";
    public static final String ftpHost="192.168.236.1";
...
//    public static final String ftpHost="172.18.16.141";
    ...
    public static final String downLoadPath=getSDPath()+"/WebWare/DownLoad";
